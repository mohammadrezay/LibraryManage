...
{
    public class DecreaseBookCopiesCommandHandler : IRequestHandler<DecreaseBookCopiesCommand, Unit>
    {
        private readonly IUnitOfWork _unitOfWork;

        public DecreaseBookCopiesCommandHandler(IUnitOfWork unitOfWork)
        {
            _unitOfWork = unitOfWork;
        }

        public async Task<Unit> Handle(DecreaseBookCopiesCommand request, CancellationToken cancellationToken)
        {
            ...
            book.DecreaseCopies(request.Amount);
