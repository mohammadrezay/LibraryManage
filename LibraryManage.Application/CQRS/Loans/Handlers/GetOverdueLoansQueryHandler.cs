...
namespace LibraryManage.Application.CQRS.Loans.Handlers
{
    public class GetOverdueLoansQueryHandler : IRequestHandler<GetOverdueLoansQuery, List<LoanDTO>>
    {
        ...
        public GetOverdueLoansQueryHandler(ILoanQueryService loanQueryService)
        {
        ...
        {
            return await _loanQueryService.GetOverdueLoansAsync(request.ReferenceDate, cancellationToken);
        }
    }
}